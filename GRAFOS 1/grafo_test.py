...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        # Grafo da Paraíba
        self.g_p = Grafo(['J', 'C', 'E', 'P', 'M', 'T', 'Z'], {'a1':'J-C', 'a2':'C-E', 'a3':'C-E', 'a4':'C-P',
                                                               'a5':'C-P', 'a6':'C-M', 'a7':'C-T', 'a8':'M-T', 'a9':'T-Z'})

        # Grafo da Paraíba sem arestas paralelas
        self.g_p_sem_paralelas = Grafo(['J', 'C', 'E', 'P', 'M', 'T', 'Z'], {'a1': 'J-C', 'a3': 'C-E', 'a4': 'C-P',
    ...
    def test_ha_laco(self):
        ...
        print(self.g_p.ha_laco())
        self.assertFalse(self.g_p_sem_paralelas.ha_laco())
        print(self.g_p_sem_paralelas.ha_laco())
        self.assertTrue(self.g_l1.ha_laco())
        print(self.g_l1.ha_laco())
        self.assertTrue(self.g_l2.ha_laco())
        print(self.g_l2.ha_laco())
        self.assertTrue(self.g_l3.ha_laco())
        print(self.g_l3.ha_laco())
        self.assertTrue(self.g_l4.ha_laco())
        print(self.g_l4.ha_laco())
        self.assertTrue(self.g_l5.ha_laco())
        print(self.g_l5.ha_laco())
    ...
    def test_comprimento_de_tamanho_n(self):
        ...
        self.assertFalse((self.g_c.comprimento_de_tamanho_n(3)))
    ...
    def test_ha_ciclo(self):
        self.assertEqual(self.g_p.ha_ciclo(), ["C-E", "E-C"])
        self.assertEqual(self.g_p_sem_paralelas.ha_ciclo(), ['C-T', 'T-M', 'M-C'])
        self.assertEqual(self.g_c.ha_ciclo(), ['J-E', 'E-C', 'C-J'])
        self.assertEqual(self.g_c2.ha_ciclo(), ['J-E', 'E-C', 'C-J'])
        self.assertFalse(self.g_c3.ha_ciclo())
        self.assertEqual(self.g_l1.ha_ciclo(), ["A-A"])
        self.assertEqual(self.g_l3.ha_ciclo(), ["C-C"])
        self.assertEqual(self.g_l4.ha_ciclo(), ["D-D"])
        self.assertEqual(self.g_l5.ha_ciclo(), ["C-C"])
